...
export default function ChangelogEl(props: Version) {
  ...
  return (
    <>
      <div className="w-[40vw] bg-black justify-self-center self-center border-2 p-5 rounded-2xl flex flex-col overflow-x-scroll justify-center content-center border-red-600 border-solid m-2">
